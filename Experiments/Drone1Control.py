"""
__title__    = Drone1Control.py
__author__   = 'Hansen Wong // 王之超'
__time__     = 2022/2/11 21:45
...
def getKeyboardInput(drone, speed, image):
    ...
    if key_pressed == 1:
        ...
        with open('Drone1-plus-{}.csv'.format(time.strftime("%Y%m%d", time.localtime())), 'a') as f:
