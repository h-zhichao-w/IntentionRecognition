...
__time__ = 2021/7/29 18:10
__file__ = dubins_test.py
...
def main():
    draw_circle((6000, 0), 1500, 'r--')
    draw_circle((6000, 0), 3000, 'y--')
    draw_circle((6000, 0), 4500, 'g--')
    # User's waypoints: [x, y, heading (degrees)]
    pt1 = Waypoint(0, 0, rd.randint(-90, 90))
    pt2 = Waypoint(7677, -1799, rd.randint(-90, 90))
    pt3 = Waypoint(9000, 5196, rd.randint(-90, 90))
    pt4 = Waypoint(6321, -2439, rd.randint(-90, 90))
    pt5 = Waypoint(9000, -5196, rd.randint(-90, 90))
    pt6 = Waypoint(4845, -2172, rd.randint(-90, 90))
    Wptz = [pt1, pt2, pt3, pt4, pt5, pt6]
    color = ['r', 'b', 'g']
    # Run the code
    i = 0
    while i<len(Wptz)-1:
        ...
        plt.plot(path[:,0],path[:,1],color[int(i/2)]+'-')
        i+=2
    plt.grid(True)
    plt.axis("equal")
