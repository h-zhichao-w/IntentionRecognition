...
__time__ = 2021/7/10 20:58
__file__ = TF_airsim.py
...
dataset = pd.read_csv('data_airsim.csv')
Para = dataset.iloc[0: , 0: 21].values
Output = dataset.iloc[0: , 21].values

train_data, test_data, train_label, test_label = train_test_split(Para, Output, test_size = 1/5, random_state = 0)

train_data.shape = (train_data.shape[0], 1, 21)
test_data.shape = (test_data.shape[0], 1, 21)
